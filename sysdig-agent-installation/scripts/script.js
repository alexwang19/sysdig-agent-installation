...
function generateInstallCommandForStaticValues() {
  ...
  return `<strong>REVIEW PRE-REQ DOCS <a target="_blank"
        href="https://github.com/draios/hack-23/blob/main/projects/Krakenizer/sysdig-agent-installation/README.md">HERE</a> </strong><br>Install Commands<br>Copy the above content and save to a file for future reference. <br><br> Click Download button to download static-configs.yaml file. 
  <br>This contains standard configs for all Verizon Sysdig deployments. <br>
...
function generateInstallCommand() {
  ...
  return `<strong>REVIEW PRE-REQ DOCS <a target="_blank"
        href="https://github.com/draios/hack-23/blob/main/projects/Krakenizer/sysdig-agent-installation/README.md">HERE</a></strong><br>Install Commands<br>helm repo add sysdig https://charts.sysdig.com --force-update <br><br> helm upgrade -i --force sysdig-agent --namespace ${namespace} --create-namespace -f values.yaml sysdig/sysdig-deploy`
}
